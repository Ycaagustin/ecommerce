    ...
    <div class="container">
        ...
        <div class="box">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <img src="produk/<?php echo $p->produk_foto?>" width="100px">
                <input type="hidden" name="foto" value="<?php echo $p->produk_foto ?>">
                <input type="file" name="gambar" class="input-control">
                <textarea class="input-control" name="deskripsi" placeholder="Deskripsi"><?php echo $p->produk_deskripsi ?></textarea><br><br>
