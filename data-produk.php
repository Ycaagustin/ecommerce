        ...
        <div class="box">
            ...
            <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    <?php
                        $no =1;
                        $produk = mysqli_query($conn, " SELECT tb_produk.*, tb_kategori.kategori_name 
                         FROM tb_produk 
                    ...
                    <tr>
                        ...
                        <td><a href="produk/<?php echo $row['produk_foto'] ?>" target="_blank"><img src="produk/<?php echo $row['produk_foto']?>" width="50px"></a></td>
                        <td><?php echo ($row['produk_status']== 0)? 'Tidak Aktif': 'Aktif'; ?></td>
                        <td>
                            <a href="edit-produk.php?id=<?php echo $row['produk_id'] ?>">Edit</a> || <a href="
                            proses-hapus.php?id=<?php echo $row['produk_id'] ?>" onclick="return confirm('Yakin ingin hapus ?'
                            )">Hapus</a>
                        </td>
                    </tr>
                    <?php } }else{ ?>
